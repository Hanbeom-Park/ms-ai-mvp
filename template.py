...
요청 받은 스펙의 각 요소(Tomcat, Oracle, OS 등)를 분리하고, 각각에 대해 다음 정보를 찾아 매칭하세요:
...
다음 항목을 포함한 구조적인 답변을 작성하세요:

1. 관련 가이드라인 항목 제목 (정책 문서에 명시된 것과 일치하게)
2. 적용 가능한 설계 원칙 요약
3. 준수해야 할 표준/제약사항 (예: SKU 제한, Naming Rule 등)
4. 기타 고려해야 할 사항이나 예외 조항
"""
...
| 리소스 유형 | 리소스 이름 (예시 포함) | 스펙/크기 | 권장 설정 | 관련 가이드라인 항목 |
|-------------|-------------------------|------------|------------|------------------------|
| VM          | vm-az01-prd-web-01      | Standard_D2s_v3 | ZoneRedundant | 컴퓨트 SKU 선택 가이드 |
